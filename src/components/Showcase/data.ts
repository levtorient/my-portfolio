...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'AI-powered content creation platform using GPT models for blog posts, marketing copy, and more.',
    tech: ['Next.js', 'Python', 'OpenAI', 'MongoDB'],
    link: 'https://example.com',
  },
  {
    title: 'Real-Time Analytics Dashboard',
    description: 'Interactive dashboard for visualizing business metrics with customizable widgets and reports.',
