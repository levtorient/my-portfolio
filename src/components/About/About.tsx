...
export default function About() {
  ...
  useEffect(() => {
    ...
    const updateConnectorPosition = () => {
      ...
      const orbitRings = containerRef.current.querySelectorAll('.orbit-ring:not(.blank-orbit)')
      const activeRing = orbitRings[activeOrbit] as HTMLElement
      const iconButton = activeRing?.querySelector('.satellite-dot') as HTMLElement
      ...
      connectorAnimationRef.current = requestAnimationFrame(updateConnectorPosition)
    }
  ...
  const handleDotHover = (index: number | null, event?: React.MouseEvent) => {
    ...
    if (index !== null && event && containerRef.current) {
      ...
      const iconButton = orbitRing.querySelector('.satellite-dot') as HTMLElement
